 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(L,G){var Q=L.length;L.push(G);e:for(;0<Q;){var Te=Q-1>>>1,Le=L[Te];if(0<i(Le,G))L[Te]=G,L[Q]=Le,Q=Te;else break e}}function n(L){return L.length===0?null:L[0]}function r(L){if(L.length===0)return null;var G=L[0],Q=L.pop();if(Q!==G){L[0]=Q;e:for(var Te=0,Le=L.length,Da=Le>>>1;Te<Da;){var br=2*(Te+1)-1,Kc=L[br],Nr=br+1,Oa=L[Nr];if(0>i(Kc,Q))Nr<Le&&0>i(Oa,Kc)?(L[Te]=Oa,L[Nr]=Q,Te=Nr):(L[Te]=Kc,L[br]=Q,Te=br);else if(Nr<Le&&0>i(Oa,Q))L[Te]=Oa,L[Nr]=Q,Te=Nr;else break e}}return G}function i(L,G){var Q=L.sortIndex-G.sortIndex;return Q!==0?Q:L.id-G.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,p=!1,g=!1,y=!1,k=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(L){for(var G=n(u);G!==null;){if(G.callback===null)r(u);else if(G.startTime<=L)r(u),G.sortIndex=G.expirationTime,e(l,G);else break;G=n(u)}}function E(L){if(y=!1,v(L),!g)if(n(l)!==null)g=!0,qc(T);else{var G=n(u);G!==null&&Gc(E,G.startTime-L)}}function T(L,G){g=!1,y&&(y=!1,m(A),A=-1),p=!0;var Q=d;try{for(v(G),h=n(l);h!==null&&(!(h.expirationTime>G)||L&&!se());){var Te=h.callback;if(typeof Te=="function"){h.callback=null,d=h.priorityLevel;var Le=Te(h.expirationTime<=G);G=t.unstable_now(),typeof Le=="function"?h.callback=Le:h===n(l)&&r(l),v(G)}else r(l);h=n(l)}if(h!==null)var Da=!0;else{var br=n(u);br!==null&&Gc(E,br.startTime-G),Da=!1}return Da}finally{h=null,d=Q,p=!1}}var x=!1,N=null,A=-1,W=5,V=-1;function se(){return!(t.unstable_now()-V<W)}function R(){if(N!==null){var L=t.unstable_now();V=L;var G=!0;try{G=N(!0,L)}finally{G?Ln():(x=!1,N=null)}}else x=!1}var Ln;if(typeof f=="function")Ln=function(){f(R)};else if(typeof MessageChannel<"u"){var Pa=new MessageChannel,Y_=Pa.port2;Pa.port1.onmessage=R,Ln=function(){Y_.postMessage(null)}}else Ln=function(){k(R,0)};function qc(L){N=L,x||(x=!0,Ln())}function Gc(L,G){A=k(function(){L(t.unstable_now())},G)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(L){L.callback=null},t.unstable_continueExecution=function(){g||p||(g=!0,qc(T))},t.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):W=0<L?Math.floor(1e3/L):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(L){switch(d){case 1:case 2:case 3:var G=3;break;default:G=d}var Q=d;d=G;try{return L()}finally{d=Q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(L,G){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var Q=d;d=L;try{return G()}finally{d=Q}},t.unstable_scheduleCallback=function(L,G,Q){var Te=t.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?Te+Q:Te):Q=Te,L){case 1:var Le=-1;break;case 2:Le=250;break;case 5:Le=1073741823;break;case 4:Le=1e4;break;default:Le=5e3}return Le=Q+Le,L={id:c++,callback:G,priorityLevel:L,startTime:Q,expirationTime:Le,sortIndex:-1},Q>Te?(L.sortIndex=Q,e(u,L),n(l)===null&&L===n(u)&&(y?(m(A),A=-1):y=!0,Gc(E,Q-Te))):(L.sortIndex=Le,e(l,L),g||p||(g=!0,qc(T))),L},t.unstable_shouldYield=se,t.unstable_wrapCallback=function(L){var G=d;return function(){var Q=d;d=G;try{return L.apply(this,arguments)}finally{d=Q}}}})(U0);(function(t){t.exports=U0})(_T);/**
 * @license React
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function B(t="Unexpected state"){const e=`FIRESTORE (${vs}) INTERNAL ASSERTION FAILED: `+t;throw Cn(e),new Error(e)}function de(t,e){t||B()}function q(t,e){return t}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const YN=new we(U.comparator);function bn(){return YN}const Yk=new we(U.comparator);function Hs(...t){let e=Yk;for(const n of t)e=e.insert(n.key,n);return e}function Xk(t){let e=Yk;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Ur(){return oo()}function Jk(){return oo()}function oo(){return new ys(t=>t.toString(),(t,e)=>t.isEqual(e))}const XN=new we(U.comparator),JN=new st(U.comparator);function Y(...t){let e=JN;for(const n of t)e=e.add(n);return e}const ZN=new st(ne);function eA(){return ZN}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
