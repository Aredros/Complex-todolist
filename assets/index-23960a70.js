 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(L,q){var Q=L.length;L.push(q);e:for(;0<Q;){var Se=Q-1>>>1,Le=L[Se];if(0<i(Le,q))L[Se]=q,L[Q]=Le,Q=Se;else break e}}function n(L){return L.length===0?null:L[0]}function r(L){if(L.length===0)return null;var q=L[0],Q=L.pop();if(Q!==q){L[0]=Q;e:for(var Se=0,Le=L.length,Oa=Le>>>1;Se<Oa;){var Ar=2*(Se+1)-1,Qc=L[Ar],Rr=Ar+1,La=L[Rr];if(0>i(Qc,Q))Rr<Le&&0>i(La,Qc)?(L[Se]=La,L[Rr]=Q,Se=Rr):(L[Se]=Qc,L[Ar]=Q,Se=Ar);else if(Rr<Le&&0>i(La,Q))L[Se]=La,L[Rr]=Q,Se=Rr;else break e}}return q}function i(L,q){var Q=L.sortIndex-q.sortIndex;return Q!==0?Q:L.id-q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],c=1,h=null,d=3,m=!1,g=!1,w=!1,k=typeof setTimeout=="function"?setTimeout:null,p=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(L){for(var q=n(u);q!==null;){if(q.callback===null)r(u);else if(q.startTime<=L)r(u),q.sortIndex=q.expirationTime,e(l,q);else break;q=n(u)}}function _(L){if(w=!1,y(L),!g)if(n(l)!==null)g=!0,Gc(T);else{var q=n(u);q!==null&&Kc(_,q.startTime-L)}}function T(L,q){g=!1,w&&(w=!1,p(A),A=-1),m=!0;var Q=d;try{for(y(q),h=n(l);h!==null&&(!(h.expirationTime>q)||L&&!ie());){var Se=h.callback;if(typeof Se=="function"){h.callback=null,d=h.priorityLevel;var Le=Se(h.expirationTime<=q);q=t.unstable_now(),typeof Le=="function"?h.callback=Le:h===n(l)&&r(l),y(q)}else r(l);h=n(l)}if(h!==null)var Oa=!0;else{var Ar=n(u);Ar!==null&&Kc(_,Ar.startTime-q),Oa=!1}return Oa}finally{h=null,d=Q,m=!1}}var x=!1,N=null,A=-1,G=5,U=-1;function ie(){return!(t.unstable_now()-U<G)}function P(){if(N!==null){var L=t.unstable_now();U=L;var q=!0;try{q=N(!0,L)}finally{q?Un():(x=!1,N=null)}}else x=!1}var Un;if(typeof f=="function")Un=function(){f(P)};else if(typeof MessageChannel<"u"){var Da=new MessageChannel,eT=Da.port2;Da.port1.onmessage=P,Un=function(){eT.postMessage(null)}}else Un=function(){k(P,0)};function Gc(L){N=L,x||(x=!0,Un())}function Kc(L,q){A=k(function(){L(t.unstable_now())},q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(L){L.callback=null},t.unstable_continueExecution=function(){g||m||(g=!0,Gc(T))},t.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):G=0<L?Math.floor(1e3/L):5},t.unstable_getCurrentPriorityLevel=function(){return d},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(L){switch(d){case 1:case 2:case 3:var q=3;break;default:q=d}var Q=d;d=q;try{return L()}finally{d=Q}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(L,q){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var Q=d;d=L;try{return q()}finally{d=Q}},t.unstable_scheduleCallback=function(L,q,Q){var Se=t.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?Se+Q:Se):Q=Se,L){case 1:var Le=-1;break;case 2:Le=250;break;case 5:Le=1073741823;break;case 4:Le=1e4;break;default:Le=5e3}return Le=Q+Le,L={id:c++,callback:q,priorityLevel:L,startTime:Q,expirationTime:Le,sortIndex:-1},Q>Se?(L.sortIndex=Q,e(u,L),n(l)===null&&L===n(u)&&(w?(p(A),A=-1):w=!0,Kc(_,Q-Se))):(L.sortIndex=Le,e(l,L),g||m||(g=!0,Gc(T))),L},t.unstable_shouldYield=ie,t.unstable_wrapCallback=function(L){var q=d;return function(){var Q=d;d=q;try{return L.apply(this,arguments)}finally{d=Q}}}})(X1);(function(t){t.exports=X1})(CT);/**
 * @license React
